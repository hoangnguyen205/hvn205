...
void DeviceManager::updateDataCore()
{
    ...
    data_core_co2.humidity =  this->data_core.humidity;
    data_core_co2.temperature =  this->data_core.temperature;
    data_core_co2.pressure =  this->data_core.pressure;
    data_core_co2.pm1_0 =  this->data_core.pm1_0;
    data_core_co2.pm2_5 =  this->data_core.pm2_5;
    data_core_co2.pm10_0 =  this->data_core.pm10_0;
...
void DeviceManager::logDataCoreToSDCard()
{
    if(this->connected_devices_status.sd_card)
    {
        ...
        //         this->time_now.year, this->time_now.month, this->time_now.date);
        g_store.logData(file_name, this->data_core_co2, this->mac_address, this->time_now);
